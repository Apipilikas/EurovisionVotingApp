...
DocumentUtils.revealScreen = function() {
    const loader = document.getElementById("loader");
    loader.firstElementChild.classList.add("fade-out");
 ...
 */
DocumentUtils.redirectToPage = function(pagePath) {
 ...
 */
DocumentUtils.redirectToPage = function(url) {
